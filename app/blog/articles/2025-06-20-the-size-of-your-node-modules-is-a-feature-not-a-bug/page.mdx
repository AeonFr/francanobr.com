...
By leveraging an extensive catalog of “Lego bricks,” each project accomplishes more with less code. That modularity also means swap-outs are painless when a library becomes unmaintained or a better alternative appears. Innovation flourishes when small pieces can be independently optimized and replaced.
...
* From imperative UIs (think Backbone) to declarative JSX, ultimately converging on React and its kin
