export const metadata = {
  ...
  openGraph: {
    images: [
      {
        url: `/api/og/${Buffer.from(JSON.stringify({ title: 'You can’t replace Redux with Hooks and Context', date: '2023.01.24' })).toString("base64")}`,
        width: 1200,
        height: 630,
      }
    ]
...
import EnhancedExperienceLoader from "./EnhancedExperienceLoader";
